    ...
    >
      ...
      <div className="max-w-2xl space-y-8 animate-slide-in-right">
        ...
        <div className="flex gap-4 animate-fade-in-up" style={{animationDelay: '0.8s'}}>
          <a 
            href="https://github.com/vasukox" 
            target="_blank" 
            rel="noopener noreferrer" 
            aria-label="GitHub"
            className="w-12 h-12 border-2 border-gray-300 dark:border-gray-600 rounded-2xl flex items-center justify-center hover:bg-gradient-to-r hover:from-purple-600 hover:to-blue-600 hover:border-transparent transition-all duration-300 cursor-pointer group"
          >
          ...
          <a 
            href="https://www.linkedin.com/in/andres-felipe-diaz-bernal-875073268/" 
            target="_blank" 
            rel="noopener noreferrer" 
            aria-label="LinkedIn"
            className="w-12 h-12 border-2 border-gray-300 dark:border-gray-600 rounded-2xl flex items-center justify-center hover:bg-gradient-to-r hover:from-purple-600 hover:to-blue-600 hover:border-transparent transition-all duration-300 cursor-pointer group"
          ...
          <a 
            href="https://twitter.com/FelipeB63666943" 
            target="_blank" 
            rel="noopener noreferrer" 
