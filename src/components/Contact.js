        ...
        <div className="bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 rounded-3xl p-8 shadow-2xl animate-slide-in-right">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4 group">
              ...
              <a href="mailto:tuemail@dominio.com" className="text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 transition-all duration-300 group-hover:translate-x-1">
                tuemail@dominio.com
              </a>
            </div>
            ...
            <div className="flex items-center gap-4 group">
              <div className="w-6 h-6 border-2 border-purple-600 dark:border-purple-400 rounded-full group-hover:bg-purple-600 dark:group-hover:bg-purple-400 transition-all duration-300"></div>
              <a href="https://www.tusitio.com" className="text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 transition-all duration-300 group-hover:translate-x-1">
                www.tusitio.com
              </a>
            </div>
          </div>
          ...
          <div className="flex gap-4 mt-8">
            <a href="https://github.com/vasukox?tab=repositories" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="w-10 h-10 border-2 border-gray-300 dark:border-gray-600 rounded-2xl hover:bg-gradient-to-r hover:from-purple-600 hover:to-blue-600 hover:border-transparent transition-all duration-300 cursor-pointer group flex items-center justify-center">
